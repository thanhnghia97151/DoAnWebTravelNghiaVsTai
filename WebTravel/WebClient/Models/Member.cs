...
namespace WebClient.Models
{
    public class Member
    {
        ...
        [RegularExpression("^([0-9][0-9]{9})|([0-9][0-9]{11})$", ErrorMessage = "Số điện thoại phải có 10 hoặc 12 chữ số")]
        public string Phone { get; set; }

        [Required(ErrorMessage = "Địa chỉ không được để trống")]
        [StringLength(60, ErrorMessage = "Địa chỉ phải nhỏ hơn hoặc bằng 60 ký tự")]
        [RegularExpression("^[a-zA-Z\\s\\.]+$", ErrorMessage = "Địa chỉ phải là chuỗi ký tự")]
