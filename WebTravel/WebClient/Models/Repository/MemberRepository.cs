...
namespace WebClient.Models.Repository
{
    public class MemberRepository : BaseRepository
    {
        ...
        public async Task<int> ConfirmNumberPhone(Member obj)
        {
         ...
         public async Task<int> ChangeConfirmStatusPhone(Member obj)
        {
            return await Post<Member>($"/api/auth/confirm-status-phone/{obj.Phone}", obj);
        }

        public async Task<int> MemberByPhone(Member obj)
        {
            return await Post<Member>($"/api/auth/check-phone/{obj.Phone}", obj);
        }
    }
}
